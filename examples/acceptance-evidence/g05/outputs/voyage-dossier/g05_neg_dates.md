# Voyage dossier · g05_missing_dates_voyage

Run g05_neg_dates · status stopped
...
- run: g05_neg_dates_01
- status: executed
- artifacts: 4
- ledger: <evidence-root>\outputs\neg_dates_01_registry\ledger\g05_neg_dates_01.json
...
- run: g05_neg_dates_02
- status: blocked
- artifacts: 2
- ledger: <evidence-root>\outputs\neg_dates_02_timeline\ledger\g05_neg_dates_02.json
- model: nemofold-local-core (level: default)
- model note: No preference was set at any level; the local engine is the default.
- outbound rights: draft_only (level: default)
- errors: undetermined_cost_due_dates:1
