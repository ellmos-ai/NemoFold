...
Run g12_telegram · status stopped
...
- status: executed
- artifacts: 3
- ledger: <evidence-root>\work\telegram_out1\ledger\g12_telegram_01.json
...
- status: executed
- artifacts: 4
- ledger: <evidence-root>\work\telegram_out2\ledger\g12_telegram_02.json
- model: nemofold-local-core (level: default)
- model note: No preference was set at any level; the local engine is the default.
- outbound rights: draft_only (level: default)
...
- artifacts: 0
- ledger: <evidence-root>\work\telegram_out3\ledger\g12_telegram_03.json
- model: nemofold-local-core (level: default)
- model note: No model or consumer ran: the artifact handoff failed.
- outbound rights: draft_only (level: default)
- errors: recipient_bridge_telegram_not_implemented
